...
public class EditingNotes extends BaseTest{
    ...
    public void editNoteTitle(Note editedNote, Note desiredNote) {
        ...
        softAssert.assertEquals(1, homePageSteps.getNotesCount(), "There is 1 new note on the Home page");
